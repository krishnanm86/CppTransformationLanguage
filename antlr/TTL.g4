...
transformationrule: tagname '{{' transformationrule+ '}}'
                    | tagname  '<' Identifier '>' '{{' transformationrule+ '}}'
                    | tagdecl 
                    | mapdecl 
                    | transformationexpression '===' Identifier '('transformationexpression')' ';;'
                    | transformationexpression '===' Identifier '('transformationexpression')' conditions ';;'
                    |transformationexpression '===' Identifier   '('transformationexpression')' '{{' conditions '}}';
transformationexpression: astname cc
                          | astname cc taguse
                          | cc taguse
                          | cc                          
                          | taguse;
                          
taguse: tagname '<' taguse '>' '(' cc ')'
        | tagname '<' cc '>' '(' cc ')'
        | tagname '(' cc ')';
...
conditions:  ttlcondition+ 
             | ;
ttlcondition: 'where' cc
           | 'where' mapElement 'in' mapName
           | 'using' cc
           | 'mutable' Identifier
           | 'where' '{{'cc'}}'
           | 'using' '{{'cc'}}'
           | 'mutable' '{{'Identifier'}}';
mapElement: Identifier
...
astname: 'stmt' | 'type' | 'decl' | 'id' | 'expr' ; //TODO: List incomplete. Extend it as needed

mapdecl: 'map ' Identifier '(' listofpairs ')' ';;';
listofpairs: StringLiteral ':' StringLiteral ',' listofpairs
            | /*Epsilon */ ;
...
tagname: Identifier ;
 ...
 /*
cc: cctoken ccprime;
cctoken: translationunit;

ccprime: cctoken ccprime
         | '{{' ccprime '}}' ccprime
         | ';;' ccprime;
 */
