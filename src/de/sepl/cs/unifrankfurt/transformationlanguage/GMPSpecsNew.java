...
public class GMPSpecsNew {
	...
	public static Set<TTlRule> populateRules() throws Exception {
		...
		TTlExpression ruleConstructExpression0_1 = new TTlExpression("mpz_t __ttlname__;", NodeType.Statement);
		rules.add(new TTlRule(rulePattern0_1, ruleConstructExpression0_1, NodeType.Statement,
				new HashMap<Scope, String>(), new HashMap<Tag, String>()));
		...
		TTlExpression ruleConstructExpression3_1 = new TTlExpression("mpz_cmp_ui(__ttlp__,__ttlp2__) __ttlop__ 0",
				NodeType.Expression);
